...
<div class="navbar bg-yellow-300">
  <div class="flex-1">
    <a class="btn btn-ghost text-black text-xl">Mercado Livre</a>
  </div>
  <div class="flex-none gap-3">
    <div class="form-control">
      <input type="text" placeholder="Search" class="input input-bordered md:w-auto bg-white" />
    </div>
...
<div class="navbar bg-yellow-300">
  ...
  <div class="navbar-center hidden z-40 lg:flex bg-yellow-300 text-black">
  ...
  <div class="navbar-end">
    <a class="btn bg-yellow-300 text-black hover:bg-yellow-100">Compras</a>
  </div>
</div>
