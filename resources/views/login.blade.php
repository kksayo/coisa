...
<div class="absolute w-1/2 h-screen right-0"><img src="https://images3.alphacoders.com/135/1350909.png" class="object-cover min-h-screen" alt=""></div>
<div class="relative items-end bg-gradient-to-b from-black via--500 to-black-500">
<div class="relative items-end bg-gray-900 w-1/2">
    
<div class="flex flex-col items-center justify-center min-h-screen">
<div class="bg-white border border-gray-200 rounded-xl shadow-sm dark:bg-gray-900 dark:border-neutral-700 w-[30rem]">
  <div class="p-4 sm:p-7">
    <div class="text-center">
      <h1 class="block text-2xl font-bold text-gray-800 dark:text-white">Login Sombrio</h1>
      <p class="mt-2 text-sm text-gray-600 dark:text-neutral-400">
        Não tem conta?
        <a class="text-blue-600 decoration-2 hover:underline font-medium dark:text-blue-500" href="/register">
          Registre-se aqui
        </a>
      </p>
    </div>
    ...
    <div class="mt-5">
      ...
      <form action= "{{route('logar')}}" method="POST">
        ...
        <div class="grid gap-y-4">
          <!-- Form Group -->
          <div>
            <label for="email" class="block text-sm mb-2 dark:text-white">Endereço de email</label>
            <div class="relative">
          ...
          <button type="submit" class="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none" href="/">Logar</button>
        </div>
      </form>
      <!-- End Form -->
    </div>
