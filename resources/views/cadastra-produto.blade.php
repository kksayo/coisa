<x-layout_base>
<div class="bg-[url('https://wallpaper.dog/large/20474170.jpg')] bg-no-repeat bg-cover bg-center h-screen w-screen">


<!-- Main modal -->

<div id="updateProductModal" tabindex="-1" class="overflow-y-auto overflow-x-hidden z-10 justify-center items-center flex pt-24">
            ...
            @csrf
                <div class="grid gap-4 mb-4 sm:grid-cols-2">
                    ...
                    <div>
                        ...
                        <input type="number" value="399" name="valor" id="price" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 bg-transparent dark:border-gray-800 dark:placeholder-gray-400 dark:text-gray-800 dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="$299">
                    </div>
                    <div>
